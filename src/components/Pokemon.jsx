...
const Pokemon = () => {
    ...
    return (
        <>
            <div style={{ textAlign: 'center', border: ' 15px solid #F44E3F', marginBottom: '50px', width: '100%' }}>
                ...
                <p>Stats: {pokemonInfo.stats[3].base_stat} - {pokemonInfo.stats[3].stat.name}</p>
                <p>Stats: {pokemonInfo.stats[4].base_stat} - {pokemonInfo.stats[4].stat.name}</p>
